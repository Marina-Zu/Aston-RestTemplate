...
//        when(userRepository.findByAuthorId(userId)).thenReturn(posts);
//        when(userRepository.findAllAlbumsByAuthorId(userId)).thenReturn(albums);
...
//        verify(userRepository).findByAuthorId(userId);
//        verify(userRepository).findAllAlbumsByAuthorId(userId);
