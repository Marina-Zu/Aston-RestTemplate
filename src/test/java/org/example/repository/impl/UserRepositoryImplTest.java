...
//
//    @Test
//    void testFindByAuthorIdSuccessful() {
//        Long userId = 1L;
...
//        }
//        List<Post> actualPosts = userRepository.findByAuthorId(userId);
//
...
//        Long authorId = 1L;
//
//        List<Album> result = userRepository.findAllAlbumsByAuthorId(authorId);
//
